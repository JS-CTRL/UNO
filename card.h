 ...
 */
enum Color{RED, BLUE, GREEN, YELLOW,NUM_COLORS,R_B_G_Y,R_B_G_Y_WILD};
enum Special{REVERSE=10,SKIP,DRAW2,WILD, WILD_DRAW_4};//Jeromey added
/**
 * @class Card
 * 
...
class WildCard : public Card{
    public:
    WildCard(Color c, Special s);
    string render(int) const;
    bool play(Card*, GameState&);
};

class WildDraw4Card : public Card{
    public:
    WildDraw4Card(Color c, Special s);
    string render(int) const;
    bool play(Card*, GameState&);
};
#endif